          ...
          }:
          {
            options = {
              ...
              mountpoint = lib.mkOption {
                ...
                default = "${parent.mountpoint}/${config.path}";
              };
...
in
{
  options = {
          ...
          }:
          {
            options = {
              ...
              _mount = diskoLib.mkMountOption {
                ...
                default = {
                  fs =
                    lib.attrsets.concatMapAttrs (_: swap: swap._mount.fs or { }) config.swap
              ...
              _unmount = diskoLib.mkUnmountOption {
                ...
                prefixed = true;
                default = {
                  fs = lib.attrsets.concatMapAttrs (_: swap: swap._unmount.fs or { }) config.swap // {
                    ${config.mountpoint} = ''
                      ${lib.strings.toShellVars {
                        inherit rootMountPoint;
                      }}
    ...
    _mount = diskoLib.mkMountOption {
      ...
      default = {
        fs =
          lib.attrsets.concatMapAttrs (_: subvol: subvol._mount.fs or { }) config.subvolumes
          // lib.attrsets.concatMapAttrs (_: swap: swap._mount.fs or { }) config.swap
    ...
    _unmount = diskoLib.mkUnmountOption {
      ...
      default = {
        fs =
          lib.attrsets.concatMapAttrs (_: subvol: subvol._unmount.fs or { }) config.subvolumes
          // lib.attrsets.concatMapAttrs (_: swap: swap._unmount.fs or { }) config.swap
          // lib.optionalAttrs (config.mountpoint != null) {
            ${config.mountpoint} = ''
              ${lib.strings.toShellVars {
                inherit rootMountPoint;
